...
<section id="presentation" class="ptl pbl">
  <div class="contenupres row"  >
    ...
    <div class="quotepres font-italic col-md-4 pas " >
      <p><img src="Images/icon/icons8-quote-left-25.png" alt="guillemet de citation">...Je sais à quel point les démarches à entreprendre dans les domaines administratif, financier,   commercial sont chronophages et surtout mises de coté quand on est à son compte.</p>
      <p>J'ai rapidement compris qu'il faut être accompagné pour s'en sortir... <img src="Images/icon/icons8-get-quote-25.png" alt="guillemet de citation"></p>
    </div>

    <div class="persopres col-md-6">

        <h2 class="mbm pas txt-center "><span class="bordertop borderbottom " >Amelie en quelques mots :</span></h2>
        ...
        <div class="persovaleurs row ">
          ...
          <div class="valeurs col-md-4  " >
            ...
            <table>
              <thead>
                <tr><h3 class="pbm txt-center">Mes valeurs</h3></tr>
              </thead>
              <tbody>
                <tr>
                  <td><img src="Images/icon/family.png" alt="icon de famille"></td>
                  <td class="plm">Famille / Amitié : Je tire mes forces de ces valeurs.</th>
                </tr>
               <tr>
                 <td><img src="Images/icon/justice.png" alt="icon de la justice"></td>
                 <td class="plm">Justice</td>
               </tr>
               <tr>
                 <td><img src="Images/icon/family.png" alt="icon de famille"></tdh>
                 <td class="plm">Honnêteté</td>
               </tr>
               <tr>
                 <th><img src="Images/icon/handshake.png" alt="icon poignée de main"></td>
                 <td class="plm">Respect</td>
               </tr>
               <tr>
                 <th><img src="Images/icon/don de soi.png" alt="Image d'un coeur sur la main"></td>
                 <td  class="plm"> Don de soi</td>
               </tr>
         ...
         <div class="hobbies col-md-5  " >
             <table>
              <thead>
                <tr><h3 class="pbm txt-center ">Hobbies</h3></tr>
              </thead>
              <tbody>
                <tr>
                  <td><img src="Images/icon/bike.png" alt="icon VTT"></td>
                  <td class="plm">VTT</th>
                </tr>
               <tr>
                 <td><img src="Images/icon/mountain.png" alt="icon de montagne pour randonnées"></td>
                 <td class="plm">Randonnées</td>
               </tr>
               <tr>
                 <td><img src="Images/icon/travauxmanuel.png" alt="icon de travaux manuels"></td>
                 <td class="plm">Travaux manuels</td>
               </tr>
               <tr>
                 <td><img src="Images/icon/jardinage.png" alt="icon de jardinage"> </td>
                 <td class="plm">Jardinage</td>
               </tr>
...
<section id="competences" class="mtl ptm pbl ">
  <div class=" row competencescontenu banner">

    <div class="competencesintro col-md-3 pas"   >
    ...
    <div class="col-md-7 ptl pbl" >
       <div class="row justify-content-around">
       
<div class="card col-md-3 boxshadow " style="width: 10rem;">
  <img class="card-img-top" src="Images/folder100.png" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title font-weight-bold">Gestion D'entreprise</h5>
    <p class="card-text">Gérer votre administratif professionnel et personnel</p>
  </div>
  <ul class="list-group list-group-flush">
              <li  class="list-group-item" >Courriers, emails & appels</li>
             <li  class="list-group-item" >Devis, facturations, suivis & relance</li>
              <li  class="list-group-item" >Relai de votre comptabilité et suivi de votre tresorerie </li>
...
<div class="card col-md-3 boxshadow " style="width: 10rem;">
  <img class="card-img-top" src="Images/people100.png" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title font-weight-bold">Gestion Humaine</h5>
    <p class="card-text">Gérer votre personnel.</p>
  </div>
  <ul class="list-group list-group-flush">
...
<div class="card col-md-3 boxshadow " style="width: 10rem;">
  <img class="card-img-top" src="Images/like100.png" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title font-weight-bold">Communication & Stratégie Digitale</h5>
    <p class="card-text">Optimiser votre visibilité digitale</p>
  </div>
  <ul class="list-group list-group-flush">
...
<section id="mission" class=" mtl pbl">
  <div class="container ">

...
$resultat = executeRequete("SELECT id_membre, pseudo, nom, prenom, email, adresse, code_postal, ville, statut FROM membre"); // tous les champs SAUF le mdp que l'on ne veut pas afficher !
